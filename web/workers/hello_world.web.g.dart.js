...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _extension_0__$getOperations(_this) {
      return A.LinkedHashMap_LinkedHashMap$_literal([1, new A._extension_0__$getOperations_closure(_this), 2, new A._extension_0__$getOperations_closure0(_this), 3, new A._extension_0__$getOperations_closure1(_this)], type$.int, type$.dynamic_Function_List_dynamic);
    },
    $HelloWorldInitializer($$req) {
      return new A._$HelloWorld$WorkerService();
    },
    ...
    _$HelloWorld$WorkerService: function _$HelloWorld$WorkerService() {
    ...
    main() {
      A.bootstrap(A.hello_world__$HelloWorldInitializer$closure(), null);
    },
    isSameInstance(a, b) {
      var t1 = type$.Object;
      t1._as(a);
      ...
      t1 = type$.JSObject;
      if (t1._is(a))
        t1 = t1._is(b) && A._asBool(self.Object.is(a, b));
      else
        t1 = !t1._is(b) && a === b;
      return t1;
    },
  ...
  A.HelloWorld.prototype = {
    _ensureInitialized$0() {
      var e, exception;
      if (!this._initialized)
        try {
          self.importScripts("/worker.js");
          A.print("Worker JavaScript file loaded");
          this._initialized = true;
        } catch (exception) {
          e = A.unwrapException(exception);
          A.print("Error loading worker JavaScript: " + A.S(e));
          throw exception;
        }
    },
    sayHello$0() {
      var jsResult, e, exception, t1;
      this._ensureInitialized$0();
      try {
        jsResult = A._asString(self.sayHello("Flutter"));
        return jsResult;
      } catch (exception) {
        e = A.unwrapException(exception);
        A.print("Error in sayHello: " + A.S(e));
        t1 = A.S(e);
        return "Error calling sayHello in worker: " + t1;
      }
    },
    calculateSum$2(a, b) {
      var jsResult, e, t1, exception;
      this._ensureInitialized$0();
      try {
        jsResult = A._asDouble(self.calculateSum(a, b));
        t1 = A._asInt(jsResult);
        return t1;
      } catch (exception) {
        e = A.unwrapException(exception);
        A.print("Error in calculateSum: " + A.S(e));
        return -1;
      }
    },
    getDataAsync$1(id) {
      return this.getDataAsync$body$HelloWorld(id);
    },
    getDataAsync$body$HelloWorld(id) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, jsPromise, jsResult, e, exception, t1, $async$exception;
      var $async$getDataAsync$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$self._ensureInitialized$0();
              $async$handler = 4;
              jsPromise = type$.JSObject._as(self.getDataAsync(id));
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(jsPromise, type$.String), $async$getDataAsync$1);
            case 7:
              // returning from await.
              jsResult = $async$result;
              $async$returnValue = jsResult;
              // goto return
              $async$goto = 1;
              break;
              $async$handler = 2;
            ...
            case 4:
              ...
              A.print("Error in getDataAsync: " + A.S(e));
              t1 = A.S(e);
              $async$returnValue = "Error calling getDataAsync in worker: " + t1;
              // goto return
              $async$goto = 1;
              break;
              // goto after finally
      ...
      return A._asyncStartSync($async$getDataAsync$1, $async$completer);
    }
  };
  A._extension_0__$getOperations_closure.prototype = {
    ...
    $call$body$_extension_0__$getOperations_closure0($$req) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, $$dsr, t1, t2, $$res;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $$dsr = A._$Deser$(false);
              t1 = J.getInterceptor$ax($$req);
              t2 = type$.List_dynamic;
              t1 = A._Future$value($async$self._this.calculateSum$2($$dsr.$$0$1(J.$index$ax(t2._as(t1.$index($$req, 3)), 0)), $$dsr.$$0$1(J.$index$ax(t2._as(t1.$index($$req, 3)), 1))), type$.int);
              $async$goto = 6;
  ...
  A._extension_0__$getOperations_closure0.prototype = {
    ...
    $call$body$_extension_0__$getOperations_closure($$req) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, $$dsr, t1, $$res;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $$dsr = A._$Deser$(false);
              t1 = $async$self._this.getDataAsync$1($$dsr.$$0$1(J.$index$ax(type$.List_dynamic._as(J.$index$ax($$req, 3)), 0)));
              $async$goto = 6;
              return A._asyncAwait(type$.Future_String._is(t1) ? t1 : A._Future$value(A._asString(t1), type$.String), $async$call$1);
            case 6:
              // returning from await.
              $$res = $async$result;
              $async$next.push(5);
  ...
  A._extension_0__$getOperations_closure1.prototype = {
    call$1($$req) {
      return this._this.sayHello$0();
    },
    $signature: 20
  };
  A._$HelloWorld$WorkerService.prototype = {$isWorkerService: 1};
  A._$Deser.prototype = {
    get$$$0() {
      ...
      if (value === $) {
        t1 = _this._converter;
        result = t1.value$1$0(type$.int);
        _this.___$Deser_$0_FI !== $ && A.throwLateFieldADI("$0");
        _this.set$___$Deser_$0_FI(result);
        value = result;
      }
      return value;
    },
    set$___$Deser_$0_FI(___$Deser_$0_FI) {
      this.___$Deser_$0_FI = type$.int_Function_dynamic._as(___$Deser_$0_FI);
    },
    $$0$1(arg0) {
  ...
  A.$jsify_squadronJsify.prototype = {
    call$1(obj) {
      var t1, cached, t2, len, jsArray, i, jsMap, t3, jsSet, value, res, _this = this;
      if (obj == null)
        return null;
      t1 = _this.cache;
      ...
      if (obj instanceof A._LinkedHashSet) {
        ...
        for (t1 = A._LinkedHashSetIterator$(obj, obj._modifications, obj.$ti._precomputed1), t3 = t1.$ti._precomputed1; t1.moveNext$0();) {
          value = t1._collection$_current;
          t2._as(jsSet.add(_this.call$1(value == null ? t3._as(value) : value)));
        }
        return jsSet;
      }
  ...
  A.$dartify_squadronDartify.prototype = {
    call$1(js) {
      ...
      if (typeof js === "bigint") {
        ...
        if (result == null)
          A.throwExpression(A.FormatException$("Could not parse BigInt", t1));
        return result;
      }
      res = A.dartify(js);
  ...
  A.WorkerRunner.prototype = {
    _checkOperations$0() {
      ...
      invalidKeys = A.List_List$of(new A.WhereIterable(new A.LinkedHashMapKeyIterable(t1, t2), t2._eval$1("bool(Iterable.E)")._as(new A.WorkerRunner__checkOperations_closure()), t3), true, t3._eval$1("Iterable.E"));
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 6:
              ...
              t2.toString;
              $async$self.set$_operations(A._extension_0__$getOperations(t2));
  ...
  A.ContextAwareConverter.prototype = {
    value$1$0($T) {
      ...
      if (A.createRuntimeType($T) === B.Type_int_8nG || A.createRuntimeType($T) === B.Type_double_23F || J.$eq$(op, A.instantiate1(A.converter_Converter_identity$closure(), $T)))
        return op;
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "hello_world__$HelloWorldInitializer$closure", "$HelloWorldInitializer", 35);
    var _;
    ...
    _static_1(A, "squadron_canceled_exception__SquadronCanceledExceptionExt_deserialize$closure", "SquadronCanceledExceptionExt_deserialize", 37);
    _static_2(A, "_platform__isSameInstance$closure", "isSameInstance", 25);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A._JsonStringifier, A._JsonPrettyPrintMixin, A._BigIntImpl, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException, A.CancelationToken, A.HelloWorld, A.MarshalingContext, A.LogEvent, A.LogFilter, A.LogOutput, A.LogPrinter, A.Logger, A.OutputEvent, A._WebWorkerChannel, A.WorkerRunner, A.Converter0, A.SerializationContext, A.SquadronException, A.CancelationTokenReference]);
    ...
    _inheritMany(A.Closure, [A.Instantiation, A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A.Future_wait_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._CustomHashMap_closure, A.MapBase_entries_closure, A._BigIntImpl_hashCode_finish, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A._extension_0__$getOperations_closure, A._extension_0__$getOperations_closure0, A._extension_0__$getOperations_closure1, A.bootstrap_closure0, A.bootstrap_closure, A.$jsify_closure, A.$jsify_closure0, A.$jsify_squadronJsify, A.$dartify_squadronDartify, A.JsWorkerRunnerExt_get_handle_closure, A.WorkerRunner__checkOperations_closure, A.WorkerRunner_connect_closure, A.ContextAwareConverter_value_closure, A.SquadronCanceledException_SquadronCanceledException$from_closure, A.SquadronCanceledExceptions_message_closure, A.SquadronCanceledExceptions_serialize_closure]);
    ...
    _inherit(A._$HelloWorld$WorkerService, A.HelloWorld);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(@)", "Object?(Object?)", "String()", "~(~())", "~(Object?,Object?)", "Null()", "Null(Object)", "Null(@)", "@(@)", "~(Object,StackTrace)", "Null(Object,StackTrace)", "_Future<@>(@)", "~(int,@)", "Null(@,StackTrace)", "int(int,int)", "int(int)", "@(String)", "Future<int>(List<@>)", "bool(@)", "String/(List<@>)", "~(WorkerRunner)", "Null(JSObject)", "@(@,String)", "~(LogEvent)", "bool(Object,Object)", "~(JSObject)", "bool(int)", "~(OutputEvent)", "CancelationTokenReference()", "SquadronCanceledException(CanceledException)", "String(SquadronCanceledException)", "List<@>(SquadronCanceledException)", "Null(~())", "int(Object?)", "WorkerService(List<@>)", "0^(@)<Object?>", "SquadronCanceledException?(List<@>?)", "Future<String>(List<@>)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"JavaScriptFunction":"LegacyJavaScriptObject","PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JSArray":{"List":["1"],"EfficientLengthIterable":["1"],"JSObject":[],"Iterable":["1"]},"JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JavaScriptObject":{"JSObject":[]},"LegacyJavaScriptObject":{"JSObject":[]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"EfficientLengthIterable":["1"],"JSObject":[],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2","ListIterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"ReversedListIterable":{"ListIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1","ListIterable.E":"1"},"Instantiation":{"Closure":[],"Function":[]},"Instantiation1":{"Closure":[],"Function":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Closure":[],"Function":[]},"Closure2Args":{"Closure":[],"Function":[]},"TearOffClosure":{"Closure":[],"Function":[]},"StaticClosure":{"Closure":[],"Function":[]},"BoundClosure":{"Closure":[],"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"]},"LinkedHashMapKeyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"RegExp":[]},"NativeByteBuffer":{"JSObject":[],"ByteBuffer":[],"TrustedGetRuntimeType":[]},"NativeTypedData":{"JSObject":[],"TypedData":[]},"NativeByteData":{"NativeTypedData":[],"ByteData":[],"JSObject":[],"TypedData":[],"TrustedGetRuntimeType":[]},"NativeTypedArray":{"NativeTypedData":[],"JavaScriptIndexingBehavior":["1"],"JSObject":[],"TypedData":[]},"NativeTypedArrayOfDouble":{"ListBase":["double"],"List":["double"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["double"],"EfficientLengthIterable":["double"],"JSObject":[],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"]},"NativeTypedArrayOfInt":{"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeFloat32List":{"Float32List":[],"ListBase":["double"],"List":["double"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["double"],"EfficientLengthIterable":["double"],"JSObject":[],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"TrustedGetRuntimeType":[],"ListBase.E":"double"},"NativeFloat64List":{"Float64List":[],"ListBase":["double"],"List":["double"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["double"],"EfficientLengthIterable":["double"],"JSObject":[],"TypedData":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"TrustedGetRuntimeType":[],"ListBase.E":"double"},"NativeInt16List":{"Int16List":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeInt32List":{"Int32List":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeInt8List":{"Int8List":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint16List":{"Uint16List":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint32List":{"Uint32List":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint8ClampedList":{"Uint8ClampedList":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"NativeUint8List":{"Uint8List":[],"ListBase":["int"],"List":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"EfficientLengthIterable":["int"],"JSObject":[],"TypedData":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListBase.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_AsyncAwaitCompleter":{"Completer":["1"]},"AsyncError":{"Error":[]},"_Completer":{"Completer":["1"]},"_AsyncCompleter":{"_Completer":["1"],"Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_HashMap":{"MapBase":["1","2"],"HashMap":["1","2"],"Map":["1","2"]},"_IdentityHashMap":{"_HashMap":["1","2"],"MapBase":["1","2"],"HashMap":["1","2"],"Map":["1","2"]},"_CustomHashMap":{"_HashMap":["1","2"],"MapBase":["1","2"],"HashMap":["1","2"],"Map":["1","2"]},"_HashMapKeyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"_HashMapKeyIterator":{"Iterator":["1"]},"_LinkedHashSet":{"SetBase":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"MapBase":{"Map":["1","2"]},"SetBase":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"_SetBase":{"SetBase":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"double":{"num":[]},"int":{"num":[]},"List":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"IntegerDivisionByZeroException":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"StringBuffer":{"StringSink":[]},"_$HelloWorld$WorkerService":{"WorkerService":[]},"_WebWorkerChannel":{"WorkerChannel":[]},"InternalLogger":{"Logger":[]},"_NoLogOutput":{"LogOutput":[]},"_DummyPrinter":{"LogPrinter":[]},"_LogAllFilter":{"LogFilter":[]},"CastConverter":{"Converter0":[]},"ContextAwareConverter":{"Converter0":[]},"SquadronCanceledException":{"SquadronException":[],"CanceledException":[]},"SquadronCanceledExceptions":{"SquadronCanceledException":[],"SquadronException":[],"CanceledException":[]},"SquadronError":{"SquadronException":[]},"SquadronTimeoutException":{"SquadronCanceledException":[],"SquadronException":[],"CanceledException":[]},"WorkerException":{"SquadronException":[]},"CancelationTokenReference":{"SquadronCancelationToken":[],"CancelationToken":[]},"SquadronCancelationToken":{"CancelationToken":[]},"ByteData":{"TypedData":[]},"Int8List":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Uint8List":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Uint8ClampedList":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Int16List":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Uint16List":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Int32List":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Uint32List":{"List":["int"],"EfficientLengthIterable":["int"],"TypedData":[],"Iterable":["int"]},"Float32List":{"List":["double"],"EfficientLengthIterable":["double"],"TypedData":[],"Iterable":["double"]},"Float64List":{"List":["double"],"EfficientLengthIterable":["double"],"TypedData":[],"Iterable":["double"]}}'));
...
//# sourceMappingURL=hello_world.web.g.dart.js.map
