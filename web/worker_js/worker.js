...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _sayHello($name) {
      var message = "Hellooooo, " + $name + "!";
      A.print(message);
      return message;
    },
    _calculateSum(a, b) {
      var result, i;
      for (result = 0, i = 0; i < 1000000; ++i)
        result += a * i + b * i;
      return result;
    },
    _getDataAsync(id) {
      return A._getDataAsync$body(id);
    },
    _getDataAsync$body(id) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue;
      var $async$_getDataAsync = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              A.print("Fetching data for ID: " + A.S(id) + " (in worker)");
              $async$returnValue = A.Future_Future$delayed(A.Duration$(500), new A._getDataAsync_closure(id), type$.String);
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_getDataAsync, $async$completer);
    },
    main() {
      var t1 = type$.JavaScriptFunction;
      A._setPropertyUnchecked(A.staticInteropGlobalContext(), "sayHello", A._functionToJS1(new A.main_closure()), t1);
      A._setPropertyUnchecked(A.staticInteropGlobalContext(), "calculateSum", A._functionToJS2(new A.main_closure0()), t1);
      A._setPropertyUnchecked(A.staticInteropGlobalContext(), "getDataAsync", A._functionToJS1(new A.main_closure1()), t1);
      A.print("Worker functions exported successfully");
    },
    _getDataAsync_closure: function _getDataAsync_closure(t0) {
      this.id = t0;
    },
  ...
  A.UnknownJsTypeError.prototype = {
    toString$0(_) {
      ...
      return A.boolConversionCheck(J.get$isEmpty$s(t1)) ? "Error" : "Error: " + A.S(t1);
    }
  };
  ...
  A._getDataAsync_closure.prototype = {
    call$0() {
      var result, i,
        t1 = this.id;
      if (typeof t1 !== "number")
        return t1.$lt();
      if (t1 < 0)
        throw A.wrapException(A.Exception_Exception("Invalid ID: " + A.S(t1)));
      for (result = 0, i = 0; i < 5000000; ++i)
        result += B.JSNumber_methods.$mod(t1 * i, 10);
      return "Data for ID " + A.S(t1) + " processed with result: " + result;
    },
    $signature: 17
  };
  A.main_closure.prototype = {
    call$1($name) {
      return A.StringToJSString_get_toJS(A._sayHello(A.JSStringToString_get_toDart(A._asString($name))));
    },
    $signature: 4
  };
  A.main_closure0.prototype = {
    call$2(a, b) {
      A._asDouble(a);
      A._asDouble(b);
      return A.NumToJSExtension_get_toJS(A._calculateSum(A.JSNumberToNumber_get_toDartInt(a), A.JSNumberToNumber_get_toDartInt(b)));
    },
    $signature: 18
  };
  A.main_closure1.prototype = {
    call$1(id) {
      var t1 = type$.String;
      return A.FutureOfJSAnyToJSPromise_get_toJS(A._getDataAsync(A.JSNumberToNumber_get_toDartInt(A._asDouble(id))).then$1$1(new A.main__closure(), t1), t1);
    },
    $signature: 19
  };
  A.main__closure.prototype = {
    call$1(result) {
      return A.StringToJSString_get_toJS(A._asString(result));
    },
    $signature: 4
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 20, 0);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._ZoneFunction, A._Zone, A.ListBase, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.FutureOfJSAnyToJSPromise_get_toJS__closure, A.main_closure, A.main_closure1, A.main__closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A.FutureOfJSAnyToJSPromise_get_toJS_closure, A.FutureOfJSAnyToJSPromise_get_toJS__closure0, A.main_closure0]);
